...
<!-- Modal -->
<div class="modal fade" id="bookingItem<?php echo $bookingid; ?>" tabindex="-1" role="dialog" aria-labelledby="bookingItem<?php echo $bookingid; ?>" aria-hidden="true" style="width: -webkit-fill-available;">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(111 202 203);">
                <h5 class="modal-title" id="bookingItem<?php echo $bookingid; ?>">Booking Items (<b>Booking Id: <?php echo $bookingid; ?></b>)</h5>
                                ...
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="/project_rbs/img/item-'.$itemId. '.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
