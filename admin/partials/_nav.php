<header class="header" id="header">
        ...
        <div class="header__img">
            <img src="assetsForSideBar/img/profile.jpg" alt="">
        </div>
    </header>
        ...
        <nav class="nav">
            <div>
                <a href="index.php" class="nav__logo">
                    ...
                    <span class="nav__logo-name">Hotel Managment</span>
                </a>
                ...
                <div class="nav__list">
                    ...
                    <a href="index.php?page=bookingManage" class="nav-bookingManage nav__link ">
                      <i class='bx bx-bar-chart-alt-2 nav__icon' ></i>
                      <span class="nav__name">Bookings</span>
                    </a>
                    <a href="index.php?page=hotelManage" class="nav__link nav-hotelManage">
                      <i class='bx bx-folder nav__icon' ></i>
                      <span class="nav__name">Hotel List</span>
                    </a>
