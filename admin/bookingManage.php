<div class="container" style="margin-top:98px;background: aliceblue;">
    <div class="table-wrapper">
        ...
        <table class="table table-striped table-hover text-center" id="NoBooking">
            ...
            <tbody>
                <?php
                    ...
                    if($counter==0) {
                        ?><script> document.getElementById("NoBooking").innerHTML = '<div class="alert alert-info alert-dismissible fade show" role="alert" style="width:100%"> You have not Recieve any Booking!	</div>';</script> <?php
                    }
                ?>
            </tbody>
        </table>
