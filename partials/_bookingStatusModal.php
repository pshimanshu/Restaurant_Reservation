...
<?php
    $statusmodalsql = "SELECT * FROM `bookings` WHERE `userId`= $userId";
    $statusmodalresult = mysqli_query($conn, $statusmodalsql);
    while($statusmodalrow = mysqli_fetch_assoc($statusmodalresult)){
        $bookingid = $statusmodalrow['bookingId'];
        $status = $statusmodalrow['bookingStatus'];
        if ($status == 0)
            $tstatus = "Booking Placed.";
        elseif ($status == 1)
            $tstatus = "Booking Confirmed.";
        elseif ($status == 2)
            $tstatus = "Event Completed.";
        elseif ($status == 3)
            $tstatus = "Booking Denied.";
        else
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="printThis">
                <div class="container" style="padding-right: 0px;padding-left: 0px;">
                    <article class="card">
                        <div class="card-body">
                            <h6><strong>Booking ID:</strong> #<?php echo $bookingid; ?></h6>
                            <article class="card">
                            ...
                            <?php
                                if($status == 0){
                                      echo '<div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Booking Placed</span> </div>
                                            <div class="step"> <span class="icon"> <i class="fa fa-times"></i> </span> <span class="text">Booking Confirmed</span> </div>
                                            <div class="step"> <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Event Completed</span> </div>';
                                }
                                elseif($status == 1){
                                    echo '<div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Booking Placed</span> </div>
                                ...
                                elseif($status == 2){
                                    echo '<div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Booking Placed</span> </div>
                                          <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Booking Confirmed</span> </div>
                                          <div class="step active"> <span class="icon"> <i class="fa fa-box"></i> </span> <span class="text">Event Completed</span> </div>';
                                }
